    ...
    public void onResume() {
        ...
        JsonObjectRequest jsonReq = new JsonObjectRequest(Request.Method.GET, "https://rickandmortyapi.com/api/character"
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    personajes.clear();
                   Personaje[] arreglo = new Gson().fromJson(response.getString("results")
                            ,Personaje[].class);
                   personajes.addAll(Arrays.asList(arreglo));
                }catch (Exception ex){
                    personajes.clear();
                    Log.e("PERSONAJES FRAGMENT","Error en la peticion");
                }finally {
            ...
            //esto se ejecuta cuando haya un error en la peticion(no se pudo acceder al seervidor o este no devuelve json
            personajes.clear();
            Log.e("PERSONAJES FRAGMENT","Error en la peticion");
            personajesAdapter.notifyDataSetChanged();
            }
